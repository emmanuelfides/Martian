...
export class AdditemComponent implements OnInit {
  ...
  constructor(
    ...
    this.thumbuploader = new FileUploader({
      ...
      allowedMimeType: ['image/png', 'image/jpeg', 'image/webp', 'image/gif', 'video/mp4'],
      autoUpload: false,
      isHTML5: true,
      queueLimit: 1000,
    ...
    this.mediauploader = new FileUploader({
      ...
      allowedMimeType: ['image/png', 'image/jpeg', 'image/webp', 'video/mp4', 'image/gif', 'image/svg+xml','audio/webm', 'video/webm', 'audio/mp3', 'audio/wav', 'audio/ogg', 'video/ogg'],
      autoUpload: false,
      isHTML5: true,
      queueLimit: 1000,
      removeAfterUpload: false,
  ...
  onSubmit(formData:any) {
    if (this.itemForm.valid) {
      ...
      if(this.type == '') {
        this.snackBar.open('Item XX is required', "", { duration: 2000 });
        return
      }
      this.spinner = true;
      if(this.itemID!= "") {
